        ...
        <div className="bg-white">
            <div className="max-w-7xl mx-auto pt-20 pb-16 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2">
                <div className="pt-6 md:pt-32">
                    ...
                    <p className="pt-6 text-base w-auto sm:w-10/12 md:w-10/12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae autem perferendis voluptates illo exercitationem dolorem quo dolores aperiam sit adipisci error sunt.</p>
