...
export default function Navbar() {
  return (
    <Disclosure as="nav" className=" fixed top-0 left-0 right-0 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-400 border-b border-neutral-200 dark:border-neutral-700 backdrop-blur-sm bg-white/90 dark:bg-neutral-900/80 z-20">
      {({ open }: { open: any }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'text-neutral-900 dark:text-neutral-400 ' : 'text-neutral-900 dark:text-neutral-400 hover:underline',
            ...
            <div className="space-y-1 px-4 min-h-screen border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'text-neutral-900 dark:text-neutral-400' : 'text-neutral-900 dark:text-neutral-400',
