      ...
      <div className="max-w-7xl mx-auto pt-20 pb-16 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2">
        <div className="pt-6 md:pt-32 justify-center text-center sm:justify-start sm:text-start">
          <h1 className="text-5xl font-bold">
            Bienvenido a <br />{" "}
            <span className="text-indigo-950 font-extrabold">ALGORIX</span>
          </h1>
          <p className="pt-6 text-base w-auto sm:w-10/12 md:w-10/12 dark:text-neutral-400">
          ¡Conectando empresas con el futuro! Desarrollamos productos digitales y creamos soluciones personalizadas para potenciar tu éxito empresarial.
          </p>
          <div className="flex flex-auto pt-10 gap-2 min-w-[350px] justify-center sm:justify-start">
          
              <Link href={"https://wa.link/20juhc"} target="_blank">
